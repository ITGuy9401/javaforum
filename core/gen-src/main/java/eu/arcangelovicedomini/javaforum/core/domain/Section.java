    ...
    implements java.io.Serializable
{
    ...
    private java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Thread> threads = new java.util.HashSet<eu.arcangelovicedomini.javaforum.core.domain.Thread>();

    /**
     * 
     */
    public java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Thread> getThreads()
    {
        return this.threads;
    }

    public void setThreads(java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Thread> threads)
    {
        this.threads = threads;
    }

    private java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Section> childSections = new java.util.HashSet<eu.arcangelovicedomini.javaforum.core.domain.Section>();

    /**
     * 
     */
    public java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Section> getChildSections()
    {
        return this.childSections;
    }

    public void setChildSections(java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Section> childSections)
    {
    ...
    public static final class Factory
    {
         ...
         */
        public static eu.arcangelovicedomini.javaforum.core.domain.Section newInstance(java.lang.String title, java.lang.String description, eu.arcangelovicedomini.javaforum.core.domain.Area area, java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Thread> threads, java.util.Collection<eu.arcangelovicedomini.javaforum.core.domain.Section> childSections, eu.arcangelovicedomini.javaforum.core.domain.Section fatherSection)
        {
            final eu.arcangelovicedomini.javaforum.core.domain.Section entity = new eu.arcangelovicedomini.javaforum.core.domain.SectionImpl();
            entity.setTitle(title);
            entity.setDescription(description);
